...
class DemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(DemoLocalizations.of(context).getString("title")),
      ),
      body: Center(
        child: Text(DemoLocalizations.of(context).getString("ts")),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      onGenerateTitle: (BuildContext context) =>
          DemoLocalizations.of(context).getString("title"),
